...
namespace ModSink.Infrastructure.Hashing {
  public class XXHash64 : IHashFunction {
    ...
    public Task<Hash>ComputeHashAsync(Stream data,
                                      CancellationToken cancellationToken) {
      return Task.Run(() => ComputeHash(data, cancellationToken),
                      cancellationToken);
    }

    public HashAlgorithm AsHashAlgorithm() { return xxHash64.Create(); }
  }
}
